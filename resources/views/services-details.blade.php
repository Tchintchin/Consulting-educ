                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-md-push-4">
                    	...
                    	<div class="inner">
                            ...
                            <!-- Paragraph -->
                        	<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industrys standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make a type specimen book It has survived.
                            </p>
                            	...
                            	<div class="row">
                            		...
                            		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <ul>
                                            ...
                                            <li>
                                                <!-- icon -->
                                                <div class="icon"> <img src="images/some-feature1.png" alt="icon"> </div>
                                                
                                                <!-- content -->
                                                <div class="content"> <h4>Worldwide leadership</h4>
                                            ...
                                            <li>
                                                <!-- icon -->
                                                <div class="icon"> <img src="images/some-feature2.png" alt="icon"> </div>
                                                
                                                <!-- content -->
                                                <div class="content"> <h4>Growth pro system</h4>
                                                
                                                <p>typesetting industry Lorem lorem Ipsum is simply text of the print</p>
                                                </div>
                                            </li>
                            		...
                            		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <ul>
                                            ...
                                            <li>
                                                <!-- icon -->
                                                <div class="icon"> <img src="images/some-feature3.png" alt="icon"> </div>
                                            ...
                                            <li>
                                                <!-- icon -->
                                                <div class="icon"> <img src="images/some-feature4.png" alt="icon"> </div>
                                                
                                                <!-- content -->
                                                <div class="content"> <h4>Achieve success</h4>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-md-pull-8 ">
                    	...
                    	<div class="left-box">
                        	...
                        	<div class="links">
                            	<ul>
                                	<li> <a href="services-details.html" class="active">Corporate Consulting </a> </li>
                    	...
                    	<div class="left-box cta">
                        	...
                        	<!-- Image -->
                            <figure><img src="images/left-cta-icon.png" alt="User"></figure>
                    	...
                    	<div class="left-box">
                            ...
                            <div class="content">
	                            <!-- Button -->
	                            <a class="download-btn" href="images/pdf.pdf" target="_blank"> <i class="fa fa-file-pdf-o"> </i> &nbsp; Company Profile</a>
                                <!-- Button -->
	                            <a class="download-btn" href="images/pdf.pdf" target="_blank"> <i class="fa fa-file-powerpoint-o"> </i> &nbsp; Presentation PPT</a>	
							</div>
