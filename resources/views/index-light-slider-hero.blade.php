                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <h2>We corbiz </h2>
                                    <!-- H1 Heading -->
                                    <h1>Every business <br>
										start with small idea.</h1>
                                    <!-- Paragraph -->
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <p>
...
Lorem Ipsum has been the industrys standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make a type </p>
    ...
    <!-- Quick support -->
    <div id="contact" class="site-quick-support cta-optional site-grey-section">
                    ...
                    <!-- H1 heading -->
                        ...
                        <div class="cta-box2">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="left-colom">
                                    <figure> <img src="images/cta-lady.png"> </figure>
                                </div>
                            </div>

                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <!-- form -->
                                <div class="form-container-optional">
