                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="feature-box">
                            <!-- Icon -->
                            <figure> <img src="images/service-icon1.png" alt="icon"> </figure>
                            <!-- Heading -->
                            <h3>Corporate Consulting</h3>
                            <!-- Paragraph -->
                            <p>Lorem Ipsum is simply dummy of the tingand typeseing industry Lorem Ipsum been industry standard ever since the when an Lorem Ipsum.</p>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="feature-box">
                            <!-- Icon -->
                            <figure> <img src="images/service-icon2.png" alt="icon"> </figure>
                            <!-- Heading -->
                            <h3>Globle marketing</h3>
                            <!-- Paragraph -->
                            <p>Lorem Ipsum is simply dummy of the tingand typeseing industry Lorem Ipsum been industry standard ever since the when an Lorem Ipsum.</p>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="feature-box">
                            <!-- Icon -->
                            <figure> <img src="images/service-icon3.png" alt="icon"> </figure>
                            <!-- Heading -->
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="feature-box">
                            <!-- Icon -->
                            <figure> <img src="images/service-icon4.png" alt="icon"> </figure>
                            <!-- Heading -->
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="feature-box">
                            <!-- Icon -->
                            <figure> <img src="images/service-icon5.png" alt="icon"> </figure>
                            <!-- Heading -->
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="feature-box">
                            <!-- Icon -->
                            <figure> <img src="images/service-icon6.png" alt="icon"> </figure>
                            <!-- Heading -->
