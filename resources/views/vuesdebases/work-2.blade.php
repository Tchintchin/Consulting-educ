                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="site-portfolio-tabs-content">
                            ...
                            <div class="all web-development portfolio-items col-sm-4 col-xs-12">
                                ...
                                <div class="site-box">
                                    ...
                                    <div class="portfolio-caption">
                                        ...
                                        <a class="" href="case-details.html" data-gall="myGallery">
                                            <i class="fa fa-link"></i>  <!-- Icon -->
                                        </a>
                            ...
                            <!-- Web design -->
                            <div class="all web-design portfolio-items web-design logo-design web-development col-sm-4 col-xs-12">
                                <!-- box -->
                                <div class="site-box">
                                    <!-- Image -->
                            ...
                            <!-- Branding -->
                            <div class="all branding portfolio-items logo-design col-sm-4 col-xs-12">
                                <!-- box -->
                                <div class="site-box">
                                    <!-- Image -->
                            ...
                            <!-- Branding -->
                            <div class="all branding web-development web-design portfolio-items col-sm-4 col-xs-12">
                                <!-- box -->
                                <div class="site-box">
                                    <!-- Image -->
                            ...
                            <!-- Logo Design -->
                            <div class="all logo-design branding logo-design web-design portfolio-items col-sm-4 col-xs-12">
                                <!-- box -->
                                <div class="site-box">
                                    <!-- Image -->
