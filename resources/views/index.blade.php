        ...
        <div id="sequence">
            <ul class="seq-canvas">
                <li class="sequence-slide">
                    ...
                    <!-- Background Image -->
                    <div class="sequence-bg" style="background-image: url(img/405.jpg)"></div>
                ...
                <li class="sequence-slide">
                    ...
                    <!-- Background Image -->
                    <div class="sequence-bg" style="background-image: url(img/34.jpg)"></div>
                ...
                <li class="sequence-slide">
                    ...
                    <!-- Background Image -->
                    <div class="sequence-bg" style="background-image: url(img/668.jpg)"></div>
