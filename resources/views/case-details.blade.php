...
<div class="site-wrapper">
    ...
    <!-- Main banner -->
    <div class="inner-page-main-banner case-details">
		<!-- Bootstrap -->
		<div class="container">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <h2>Our Cases</h2>
                    <!-- H1 Heading -->
                    <h1>Project tile here</h1>
                    <!-- Bredcum links -->
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                        	<ul>
                            	<li> <a href="index.html">Home » </a> </li>
                                <li> <a href="work-1.html">Work » </a> </li>
                                <li>Case details</li>
                            </ul>
                            <p>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="inner">
                        ...
                        <!-- H3 heading -->
                        <h3>Process of <span class="color-text">"Corbiz” </span> from skratch to launch </h3>
                        	...
                        	<div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                	<div class="dt-box">
                                        ...
                                        <!-- Icon -->
                                        <figure> <img src="images/case-logo.png" alt="icon"> </figure>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                	<div class="dt-box">
                                        ...
                                        <!-- text -->
                                        <div class="text"> Marketing, Consulting</div>
									</div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                	<div class="dt-box">
                                        <!-- Button -->
                                        <a href="http://www.kalanidhithemes.com/" target="_blank" class="theme-btn">View Live Project</a>
									</div>
                                </div>
                        ...
                        <div class="case-iamge">
	                        <figure> <img src="images/case-detail1.jpg" alt="image"> </figure>
                        </div>
                        
                        <!-- Paragraph -->
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industrys standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make a type specimen book It has survived not only five centuries but also the leap into electronic typesetting remaining essentially unchanged It was popularised in the with the release of Letraset sheets containing Lorem Ipsum passages, and moe recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsume leap into electronic type setting. Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industrys standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make a type specimen book It has survived not only five centuries but also the leap into electronic typesetting remaining essentially unchanged It was popularised in the with the release of Letraset sheets containing Lorem Ipsum passages, and moe recently with desktop publishing software like Aldus PageMaker electronic typesetting.
                        </p>
						...
						<div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-md-push-4">
                            	<div class="right">
                                    ...
                                    <!-- Paragraph -->
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industrys standard dummy text ever since the when an unknown.
                                    </p>
                                    
                                    <!-- box -->
                                    <div class="point-box">
                                        <!-- H4 heading -->
                                        <h4>Some best features </h4>
                                        <!-- Paragraph -->
                                        <p>Dummy text ever since the when an unknown printer took a galley of type and scrambled it to make a type specimen book It has survived. not only five but also the leap into electronicDummy text ever since the when an unknown printer took.
                                        </p>
                                    </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-md-pull-8">
                                <!-- image -->
                                <div class="case-iamge">
                                    <figure> <img src="images/case-detail2.jpg" alt="image"> </figure>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3" style="display:none;">
                    ...
                    <div class="widget">
                        ...
                        <ul class="widget-news">
                            <li>
                                <a href="#">
                                    <figure><img src="images/news-1.png" alt="image"></figure>
                            ...
                            <li>
                                <a href="#">
                                    <figure><img src="images/news-2.png" alt="image"></figure>
                            ...
                            <li>
                                <a href="#">
                                    <figure><img src="images/news-3.png" alt="image"></figure>
                                    <p>Get to gethore</p>
                                    <span>20th Jul, 2016</span>
                                </a>
                            </li>
                ...
                <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="site-copyright">
                        © 2016 Made by <a href="http://www.kalanidhithemes.com/" target="_blank">Kalanidhi Themes</a>
                    </div>
