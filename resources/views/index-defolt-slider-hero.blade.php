        ...
        <div id="sequence">
            <ul class="seq-canvas">
                <li class="sequence-slide">
                    ...
                    <!-- Background Image -->
                    <div class="sequence-bg" style="background-image: url(img/139.jpg)"></div>
                ...
                <li class="sequence-slide">
                    ...
                    <!-- Background Image -->
                    <div class="sequence-bg" style="background-image: url(img/6684.jpg)"></div>
                ...
                <li class="sequence-slide">
                    ...
                    <!-- Background Image -->
                    <div class="sequence-bg" style="background-image: url(img/7348.jpg)"></div>
